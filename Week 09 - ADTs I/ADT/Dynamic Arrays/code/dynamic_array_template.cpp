...
public:
    ...
    void push_back(int item) {
        ...
        // add the item to the end of the array, you should consider which variable tracks the end of the current items in the array
        // make sure you increment this variable by 1
    }

    // Remove the last item from the array
    void pop_back() {
        // Check if the array is not empty and decrement the size to effectively "remove" the last item
